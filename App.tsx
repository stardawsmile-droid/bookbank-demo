          ...
          <div className="animate-fade-in-up space-y-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
              <div className="border-b border-slate-100 px-8 py-5 bg-white flex flex-wrap gap-3 items-center justify-between sticky top-0">
                ...
                <button className="hidden sm:flex items-center px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl text-sm font-semibold transition-colors">
